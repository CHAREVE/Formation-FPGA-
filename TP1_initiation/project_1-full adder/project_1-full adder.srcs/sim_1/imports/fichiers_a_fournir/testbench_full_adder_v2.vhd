...
--	S <= '0';
	...
	--assert Cout = '0' and S = '1' report "erreur calcul A=" & integer'image(A) & " B=" & integer'image(B) & " Cin=" & integer'image(Cin) severity error;
	--assert S='1' report "erreur calcul" severity error;
