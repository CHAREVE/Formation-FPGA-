...
# RGB LEDs
set_property PACKAGE_PIN L15 [get_ports led0_b]
set_property IOSTANDARD LVCMOS33 [get_ports led0_b]
#set_property -dict {PACKAGE_PIN L15 IOSTANDARD LVCMOS33} [get_ports led0_b]
#set_property -dict {PACKAGE_PIN L15 IOSTANDARD LVCMOS33} [get_ports allumer_led]
...
#set_property PACKAGE_PIN D20 [get_ports Bouton]
set_property -dict {PACKAGE_PIN D20 IOSTANDARD LVCMOS33} [get_ports Reset_Master]
...
#set_property -dict {PACKAGE_PIN L19 IOSTANDARD LVCMOS33} [get_ports Reset_Master]
...
connect_debug_port u_ila_0/clk [get_nets [list inst_clk_wiz_0/inst/clk_250Mhz]]
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe0]
set_property port_width 1 [get_debug_ports u_ila_0/probe0]
connect_debug_port u_ila_0/probe0 [get_nets [list end_cycle]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 1 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list led0_b_OBUF]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 1 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list led0_g_OBUF]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 1 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list led0_r_OBUF]]
...
connect_debug_port u_ila_1/clk [get_nets [list inst_clk_wiz_0/inst/clk_50Mhz]]
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_1/probe0]
set_property port_width 1 [get_debug_ports u_ila_1/probe0]
connect_debug_port u_ila_1/probe0 [get_nets [list led1_g_OBUF]]
create_debug_port u_ila_1 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_1/probe1]
set_property port_width 1 [get_debug_ports u_ila_1/probe1]
connect_debug_port u_ila_1/probe1 [get_nets [list led1_r_OBUF]]
